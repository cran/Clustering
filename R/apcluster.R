#' Method that runs the apclusterK algorithm using the euclidean metric to make
...
#' silhouette.
#'
#' @return returns a list with both the internal and external evaluation of
#' the grouping.
#'
#' @keywords internal
#'
...
#' Method that runs the apclusterK algorithm using the manhattan metric to make
#' an external or internal validation of the cluster.
#'
#' @param dt matrix or data frame with the set of values to be applied to the
#' algorithm.
...
#' Method that runs the apclusterK algorithm using the minkowski metric to make
#' an external or internal validation of the cluster.
#'
#' @param dt matrix or data frame with the set of values to be applied to the
#' algorithm.
